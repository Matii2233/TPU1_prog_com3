# INTEGRANTES: Salinas Matias, Chepilla Santiago, Rojas Matias, Vera Uriel, Jimenez Marcos.
...
while action != 0:
    ...
    #IF para administrar cada funcion
    if action == 1:
        print("-----------------")
        print("Extracciones")
        print("-----------------")
        ...
        if money < 1000:
            ...
            if years > 0:
                print("Su monto de ",money," pesos fue guardado")
                ...
                #Se pide un año hasta que año sea 1 o mayor
                while years < 1:
